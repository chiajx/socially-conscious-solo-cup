/*********************************************************************
This sketch is adapted from dual_bleuart.

(loaded onto Khaleesi, the board which contains the button sensor.)
...
if (holdTimer >= 10)
  {  
    bleuart.write("SOS", 3 );
    Serial.println("button held down for a while");
  }
  
else if (holdTimer > 0 && holdTimer < 10) // short press, for less than a second (red light)
    { 
      bleuart.write("OK", 2 );
